...
Evaluated PAX1/JAM3 methylation (CISCER) for triaging 322 women with ASC-US cytology. Found that methylation was significantly elevated in CIN2+ lesions.

## Triage performance in opportunistic screening of non-16/18 hrHPV+ women
...
- year: 2024
- category: Non-16/18 hrHPV
- keyFinding: Methylation reduced colposcopy referrals by 57.2% compared to cytology, with superior specificity.
- sensitivity: 84.8
- specificity: 88.5
- colposcopyReduction: 57.2
- auc: 0.866
- populationSize: 1851

Multicenter prospective study (METHY3 & 4) on 1,851 women. Compared LBC vs. Methylation for triage of non-16/18 infections.

## Enhanced diagnostic accuracy of high-grade CIN in postmenopausal women
- id: peng-ijc-2025
...
Focused on women aged ≥50. Cytology often fails in this group due to atrophy. Methylation proved highly effective.

## Feasibility Evaluation of using PAX1/JAM3 methylation markers for female self-collected samples
- id: yu-chinjlab-2024
...
Compared self-collected vs. physician-collected samples in 301 women. High correlation (r=0.858) found between sampling methods.

## PAX1 and JAM3 methylation in predicting pathological upgrading before conization
- id: chen-scirep-2025
...
- year: 2025
- category: Clinical Outcomes & Prediction
...
Investigated if methylation levels could predict if a lesion would be upgraded (worse than biopsy) after conization surgery.
...
- sensitivity: 89.0
- specificity: 95.3
- colposcopyReduction: 70.0
- auc: 0.921
- populationSize: 334

Assessed 334 women positive for HPV 16/18. Direct referral is usually recommended, but leads to overtreatment.

## Triage role of cytological DNA methylation in women with non-16/18, specifically genotyping high-risk HPV
- id: su-bjc-2025
...
Large cohort (1307 women). Compared LBC, HPV Genotyping (33/35), and Methylation.
...
Focus on "minimally abnormal" results (ASC-US/LSIL/NILM+HPV). 1,857 women analyzed.

## Performance of JAM3/PAX1 methylation in diagnosis of HSIL for women with hr-HPV
- id: sun-bmc-2024
...
Used a conditional inference tree model to optimize triage. Included 276 patients.
...
Analyzed women with persistent HPV but no high-grade lesions initially. Methylation increased significantly after 3 years of persistence.

## Assessment of PAX1 and JAM3 methylation triage efficacy across HPV genotypes and age groups
...
Studied 436 women. Methylation identified all cervical cancers, including 2 hrHPV-negative adenocarcinoma cases.
...
143 postmenopausal women. Methylation accuracy was better than other non-invasive methods.
...
Prospective evaluation of 675 patients with AUB or suspected pathology. Methylation assay yields high accuracy (97.3%) and AUC 0.92. All false-positives were related to neoplastic processes.
...
Evaluated CDO1/CELF4 methylation (CISENDO) in 296 premenopausal women with AUB. Found it to be an independent risk factor with high accuracy.
...
Prospective study of 138 postmenopausal women. Methylation using cervical scrapings (CISENDO) outperformed Ultrasound.
...
Analyzed 216 patients with AUB. Compared Methylation vs Ultrasound vs CA125.
...
Large cohort of 607 women. CDO1/CELF4 methylation was far superior to other clinical indicators.

## Application of DNA methylation in detection of endometrial carcinoma in women with abnormal uterine bleeding at childbearing age
- id: zhao-cjlm-2023
...
517 women of childbearing age. Prospective study.
...
Case-control study of 151 patients. Evaluated clinical application of cfDNA CDO1 and HOXA9 methylation for ovarian cancer.
