...
const GuidesEndoPage: React.FC = () => {
  ...
  return (
    <>
      <section className="relative min-h-[50vh] flex flex-col justify-center items-center overflow-hidden pt-20 pb-10 bg-gradient-to-b from-rose-50/50 to-white">
        <div className="absolute inset-0 pointer-events-none z-0">
           <div className="absolute top-[-20%] left-[-10%] w-[500px] h-[500px] bg-rose-100/30 rounded-full blur-[100px]"></div>
        </div>
